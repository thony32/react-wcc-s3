...
export default function Stacks() {
    ...
    const handleHover = (event: React.MouseEvent<HTMLDivElement, MouseEvent>, setValue: (value: number) => void, value: number) => {
        ...
        <div className="space-y-10 z-50">
            ...
            <div className="flex gap-14  2xl:gap-16">
                <div onMouseOver={(event) => handleHover(event, setReact, 80)} onMouseOut={(event) => handleHover(event, setReact, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative">
                            <svg className="w-16 2xl:w-28 fill-current group-hover:fill-info duration-200 group-hover:opacity-80 opacity-10" viewBox="0 0 24 24">
                            ...
                            <animated.progress className="progress progress-info w-16 2xl:w-28" value={animatedProps.reactValue.reactValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-info group-hover:opacity-80 duration-75">React</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setVue, 70)} onMouseOut={(event) => handleHover(event, setVue, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative">
                            <svg className="w-16 2xl:w-28 fill-current group-hover:fill-success duration-200 group-hover:opacity-80 opacity-10" viewBox="0 -2 28 28">
                                <path
                                    d="m22.313 0h5.688l-14 24-14-24h11l3 5.563 3.5-5.563zm-18.813 2 10.5 18 10.5-18h-3.375l-7.125 12.375-7.125-12.375z" />
                            </svg>
                            <animated.progress className="progress progress-success w-16 2xl:w-28" value={animatedProps.vueValue.vueValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-success group-hover:opacity-80 duration-75">VueJS</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setTail, 90)} onMouseOut={(event) => handleHover(event, setTail, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative">
                            ...
                            <animated.progress className="progress progress-info w-16 2xl:w-28" value={animatedProps.tailValue.tailValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-info group-hover:opacity-80 duration-75">Tailwind</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="flex  gap-14 2xl:gap-16">
                    ...
                    <div>
                        <div className="relative">
                            <div className="flex justify-center">
                                <svg className="w-16 2xl:w-24 fill-current group-hover:fill-success duration-200 group-hover:opacity-80 opacity-10" viewBox="0 0 16 16" fill="none">
                            ...
                            <animated.progress className="progress progress-success w-16 2xl:w-28" value={animatedProps.nodeValue.nodeValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-success group-hover:opacity-80 duration-75">NodeJS</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setLaravel, 75)} onMouseOut={(event) => handleHover(event, setLaravel, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative">
                            <div className="flex justify-center">
                                <svg className="w-16 2xl:w-24 fill-current group-hover:fill-error duration-200 group-hover:opacity-80 opacity-10" viewBox="0 0 32 32">
                                    <path
                            ...
                            <animated.progress className="progress progress-error w-16 2xl:w-28" value={animatedProps.laravelValue.laravelValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-error group-hover:opacity-80 duration-75">Laravel</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setSpring, 30)} onMouseOut={(event) => handleHover(event, setSpring, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative">
                            <div className="flex justify-center">
                                <svg className="w-16 2xl:w-24 fill-current group-hover:fill-success duration-200 group-hover:opacity-80 opacity-10" viewBox="0 0 32 32">
                            ...
                            <animated.progress className="progress progress-success w-16 2xl:w-28" value={animatedProps.springValue.springValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-success group-hover:opacity-80 duration-75">Spring</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div onMouseOver={(event) => handleHover(event, setIonic, 65)} onMouseOut={(event) => handleHover(event, setIonic, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative space-y-4">
                            <div className="flex justify-center">
                                <svg className="w-16 2xl:w-20 fill-current group-hover:fill-info duration-200 group-hover:opacity-80 opacity-10" viewBox="0 0 32 32">
                                    <path
                            ...
                            <animated.progress className="progress progress-info w-16 2xl:w-28" value={animatedProps.ionicValue.ionicValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-info group-hover:opacity-80 duration-75">Ionic</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setFlutter, 40)} onMouseOut={(event) => handleHover(event, setFlutter, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative space-y-4">
                            ...
                            <animated.progress className="progress progress-info w-16 2xl:w-28" value={animatedProps.flutterValue.flutterValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-info group-hover:opacity-80 duration-75">Flutter</span>
                        </div>
                    </div>
                </div>
                <div onMouseOver={(event) => handleHover(event, setKotlin, 25)} onMouseOut={(event) => handleHover(event, setKotlin, 2)} className="group flex justify-center">
                    <div>
                        <div className="relative space-y-4">
                            ...
                            <animated.progress className="progress progress-info w-16 2xl:w-28" value={animatedProps.kotlinValue.kotlinValue.interpolate((val) => val.toFixed(0))} max="100"></animated.progress>
                        </div>
                        <div className="text-center">
                            <span className="text-xl 2xl:text-2xl opacity-10 font-extrabold group-hover:text-info group-hover:opacity-80 duration-75">Kotlin</span>
                        </div>
                    </div>
                </div>
            </div>
