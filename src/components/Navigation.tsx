export default function Navigation() {
  return (
    <div className="flex flex-col gap-7 bg-base-100 info duration-300 p-3 card">
      <div className="tooltip tooltip-primary tooltip-left" data-tip="Home">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 cursor-pointer hover:-translate-y-1 duration-300 hover:text-primary">
      ...
      <div className="tooltip tooltip-primary tooltip-left" data-tip="About me">
        <svg className="w-7 cursor-pointer stroke-current duration-300 hover:stroke-primary hover:rotate-180" viewBox="0 0 24 24" fill="none">
      ...
      <div className="tooltip tooltip-primary tooltip-left group" data-tip="Skills">
        <svg className="w-7 stroke-current duration-300 hover:stroke-primary cursor-pointer" viewBox="0 0 24 24" fill="none">
          <path className="group-hover:-translate-x-[1px] duration-300" d="M7 8L3 12L7 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path className="group-hover:translate-x-[1px] duration-300" d="M17 8L21 12L17 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M14 4L9.8589 19.4548" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </div>
      <div className="tooltip tooltip-primary tooltip-left group" data-tip="Schools">
        <svg className="w-7 fill-current cursor-pointer hover:rotate-12 duration-300 hover:fill-primary" viewBox="0 0 92 92">
	...
	c-0.7-0.7-1.2-1.8-1.2-2.8c0-1,0.4-2.1,1.2-2.8c0.7-0.7,1.8-1.2,2.8-1.2S10.2,59.5,11,60.3z" />
      ...
      <div className="tooltip tooltip-primary tooltip-left group" data-tip="Projects">
        <svg className="w-7 stroke-current cursor-pointer hover:stroke-primary duration-300" viewBox="0 0 24 24" fill="none">
          <path opacity="0.4"
          ...
          <path
            ...
            stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          <path d="M11.995 16.6783V15.3843" stroke-width="1.5" stroke-linecap="round"
      ...
      <div className="tooltip tooltip-primary tooltip-left group" data-tip="Projects">
        <svg className="w-7 fill-current cursor-pointer hover:scale-110 duration-300 hover:fill-primary" viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
