      ...
      <div className="flex flex-col gap-8 items-center lg:p-8 2xl:p-32" uk-filter="target: .js-filter">
        <ul className="flex gap-2 lg:gap-4 z-10">
          <li onClick={() => setActiveProject("all")} className="group" uk-filter-control="[data-all='all']">
            <a className={activeProject === "all" ? "hover:no-underline hover:text-pink-500 text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg" : "hover:no-underline hover:text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg"} href="#">
          ...
          <li onClick={() => setActiveProject("web")} className="group" uk-filter-control="[data-content='web']">
            <a className={activeProject === "web" ? "hover:no-underline hover:text-pink-500 text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg" : "hover:no-underline hover:text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg"} href="#">
              <div className="flex items-center gap-4">
          ...
          <li onClick={() => setActiveProject("mobile")} className="group" uk-filter-control="[data-content='mobile']">
            <a className={activeProject === "mobile" ? "hover:no-underline hover:text-pink-500 text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg" : "hover:no-underline hover:text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg"} href="#">
              <div className="flex items-center gap-4">
          ...
          <li onClick={() => setActiveProject("desktop")} className="group" uk-filter-control="[data-content='desktop']">
            <a className={activeProject === "desktop" ? "hover:no-underline hover:text-pink-500 text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg" : "hover:no-underline hover:text-pink-500 duration-200 bg-base-100 p-4 card shadow-lg"} href="#">
              <div className="flex items-center gap-4">
              ...
              <div className="card-body space-y-4">
                ...
                <div className="text-2xl font-semibold">
                  <div className="flex gap-4">
                    <svg viewBox="0 -2 28 28" className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200">
                      <path d="m22.313 0h5.688l-14 24-14-24h11l3 5.563 3.5-5.563zm-18.813 2 10.5 18 10.5-18h-3.375l-7.125 12.375-7.125-12.375z" />
                    </svg>
                    <svg viewBox="0 0 32 32" className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200">
            ...
            <div className="card shadow-lg bg-base-100 project duration-300 w-[370px] h-[320px]">
              <div className="card-body space-y-4">
                ...
                <div className="flex gap-4">
                  <svg
                    viewBox="0 0 32 32"
                    className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200"
                  >
          ...
          <li className="group" data-all='all' data-content="desktop" uk-scrollspy="cls: uk-animation-fade; target: .card; delay: 500; repeat: true">
            <div className="card shadow-lg bg-base-100 project duration-300 w-[370px] h-[320px]">
              <div className="card-body space-y-4">
                ...
                <div className="flex gap-4">
                  <svg className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200" viewBox="0 0 512 512">
          ...
          <li className="group" data-all='all' data-content="web" uk-scrollspy="cls: uk-animation-fade; target: .card; delay: 500; repeat: true">
            <div className="card shadow-lg bg-base-100 project duration-300 w-[370px] h-[320px]">
              <div className="card-body space-y-4">
                ...
                <div className="flex gap-4">
                  <svg className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200" viewBox="0 0 24 24">
          ...
          <li className="group" data-all='all' data-content="web" uk-scrollspy="cls: uk-animation-fade; target: .card; delay: 500; repeat: true">
            <div className="card shadow-lg bg-base-100 project duration-300 w-[370px] h-[320px]">
              <div className="card-body space-y-4">
                <h1 className="text-current text-3xl font-bold group-hover:text-white duration-150">Car Rental Management</h1>
                <div className="flex gap-4">
                  <svg className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200" viewBox="0 0 256 228">
                    <path
                  ...
                  <svg viewBox="0 0 16 16" className="w-6 h-6 fill-current group-hover:fill-pink-500 duration-200">
                    <path
                      fillRule="nonzero"
                      clipRule="nonzero"
