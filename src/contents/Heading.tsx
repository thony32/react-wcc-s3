        ...
        <div className="h-full relative">
          ...
          <div className={scrollTop > 200 ? "z-40 hidden lg:block lg:fixed lg:duration-500 lg:top-3 lg:left-3" : "z-40 hidden lg:block lg:fixed lg:duration-500 lg:top-[10%] lg:left-[10%] lg:space-y-3"}>
            <div className={scrollTop > 200 ? "shadow-2xl card bg-base-100 duration-300 scale-75 group info" : "shadow-2xl card bg-base-100 duration-300 group info"}>
              <div className="flex gap-5 p-2 2xl:p-5">
                <svg className="w-5 2xl:w-7 fill-current group-hover:fill-pink-600 duration-75" viewBox="0 0 24 24" fill="none">
                  <path className="group-hover:-translate-x-[2.5px] duration-300" fillRule="evenodd" clipRule="evenodd"
            ...
            <div className={scrollTop > 200 ? "shadow-2xl card bg-base-100 duration-300 scale-75 group info" : "shadow-2xl card bg-base-100 duration-300 group info"}>
              <div className="flex gap-5 p-2 2xl:p-5">
                <svg className="w-5 2xl: stroke-current group-hover:stroke-pink-600 duration-75" viewBox="-0.5 0 25 25" fill="none">
                  <path
                  ...
                  <path d="M21.209 5.41992C15.599 16.0599 8.39906 16.0499 2.78906 5.41992" strokeWidth="1.5"
                    strokeLinecap="round" strokeLinejoin="round" />
                  <g className="group-hover:translate-x-[2px] duration-300">
                    <path d="M15.0098 18.39H23.0098" strokeWidth="1.5" strokeLinecap="round"
                      strokeLinejoin="round" />
                    <path d="M20.0098 15.39L23.0098 18.39L20.0098 21.39" strokeWidth="1.5" strokeLinecap="round"
                      strokeLinejoin="round" />
                  </g>
                </svg>
                <div className="flex flex-col">
                  <span className="text-xs">Mail</span>
                  <label className="font-bold text-xs 2xl:text-base">murielarisoaran@gmail.com</label>
                </div>
              </div>
            </div>
            <div className={scrollTop > 200 ? "shadow-2xl card bg-base-100 duration-300 scale-75 group info" : "shadow-2xl card bg-base-100 duration-300 group info"}>
              <div className="flex gap-5 p-2 2xl:p-5">
                <svg className="w-5 2xl:w-7 stroke-current group-hover:stroke-pink-600 duration-300 group-hover:-translate-y-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
