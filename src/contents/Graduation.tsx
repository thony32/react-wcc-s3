        ...
        <div className="py-8">
          <div className="container mx-auto flex flex-col items-start md:flex-row my-12 md:my-24">
            <div className="flex flex-col w-full sticky md:top-36 lg:w-1/3 mt-2 md:mt-12 px-8">
              <p className="text-[2em] text-center lg:text-left first-letter:text-6xl lg:text-[4em] lg:first-letter:text-[1.5em] 2xl:text-[5em] 2xl:first-letter:text-[2em] font-semibold  text-pink-500">
                Graduation
              </p>
            ...
            <div className="ml-0 md:ml-12 lg:w-2/3 sticky">
              <div className="container mx-auto w-full h-full">
                <div className="relative wrap overflow-hidden p-10 h-full">
                  <div className="border-2-2 border-yellow-555 absolute h-full border right-[50%] rounded-sm border-pink-500"></div>
                  <div className="border-2-2 border-yellow-555 absolute h-full border left-[50%] rounded-sm border-pink-500"></div>
                  {/* qsdlkn */}
