            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                <div className="space-y-5">
                    ...
                    <div className="flex gap-3">
                        <div className="react group card px-3 py-2 border-current hover:border-blue-500 border-2 cursor-pointer bg-base-100 duration-200 ease-in-out">
                            <div className="flex justify-between gap-3 items-center group-hover:text-blue-500">
                                <span className="font-semibold duration-75">React</span>
                        ...
                        {/* Vue Js */}
                        <div className="vue bg-base-100 group cursor-pointer hover:border-green-500 duration-300 card px-3 py-2 border-current border-2">
                            <div className="flex justify-between gap-3 items-center">
                                <span className="font-semibold group-hover:text-green-500 duration-300">Vue Js</span>
                                <svg className="w-8 fill-current group-hover:fill-green-500 duration-300" viewBox="0 0 24 24">
                                    <path d="M19.1143 2H15L12 6.9L9.42857 2H0L12 23L24 2H19.1143ZM3 3.75H5.91429L12 14.6L18.0857 3.75H21L12 19.5L3 3.75Z" />
                                </svg>
                            </div>
                        </div>
                        {/* Angular */}
                        <div className="angular bg-base-100 group duration-300 hover:border-red-500 card px-3 py-2 border-current border-2">
                            <div className="flex justify-between gap-3 items-center">
                                <span className="font-semibold group-hover:text-red-500 duration-300">Angular</span>
                                <svg className="w-8 fill-current group-hover:fill-red-500 duration-300" viewBox="0 0 24 24">
